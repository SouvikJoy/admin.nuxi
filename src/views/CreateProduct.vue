	...
	<div>
		<div class="container mx-auto mt-6">
			...
			>
				...
				<div>
					<label for="product-name" class="label-class">
						Product Name
					</label>
					<input
						id="product-name"
				...
				<div>
					<label for="product-brief" class="label-class">
						Product Brief
					</label>
					<textarea
						id="product-brief"
				...
				<div>
					<label for="product-description" class="label-class">
						Product Description
					</label>
					<textarea
				...
				<div>
					<label for="product-price" class="label-class">
						Product Price
					</label>
					<input
						id="product-price"
