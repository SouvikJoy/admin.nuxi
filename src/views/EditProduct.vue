					...
					>
						...
						<div>
							...
							<div>
								...
								<ErrorMessage class="text-xs text-red-600 font-bold tracking-wider" name="product-category" />
							</div>
						...
						<div>
							...
							<button class="danger-button mx-4" @click="deleteProduct">Delete</button>
						</div>
					</Form>
				</div>
			</div>
